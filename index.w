...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window takeout" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:160px;top:261px;"
    onLoad="modelLoad"> 
    ...
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false"
      ...
      <column label="col6" name="fID" type="String" xid="default21"></column>
  <column label="col0" name="fCreateTime" type="DateTime" xid="default15"></column>
  <column label="col1" name="fContent" type="String" xid="default16"></column>
  <column label="col2" name="fSum" type="Float" xid="default17"></column>
  <column label="col3" name="fUserID" type="String" xid="default18"></column>
  <column label="col7" name="fUserName" type="String" xid="default22"></column>
  <column label="col5" name="fPhoneNumber" type="String" xid="default20"></column>
  <column label="col4" name="fAddress" type="String" xid="default19"></column>
  <column label="col8" name="fPayState" type="Integer" xid="default7"></column>
  <filter name="userFilter" xid="filter2">fUserID = :user</filter>
                    ...
                    <div component="$UI/system/components/justep/row/row" class="x-row"
                      ...
                      <div class="x-col" xid="col27"> 
                        <div component="$UI/system/components/justep/output/output"
                          ...
                          style="color:#FF0000;font-weight:bold;background-color:transparent;"/> 
                      </div> 
                    </div>  
                    <div component="$UI/system/components/justep/row/row" class="x-row"
                      xid="row11"> 
